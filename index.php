                ...
                <form class="auth-form is-active" data-form="signin" id="signin-form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-password-wrapper">
                            ...
                            <button type="button" class="password-toggle" aria-label="Toggle password visibility" data-target="signin-password">
                ...
                <form class="auth-form" data-form="signup" id="signup-form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-password-wrapper">
                            ...
                            <button type="button" class="password-toggle" aria-label="Toggle password visibility" data-target="signup-password">
                                <svg class="icon-eye" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                    <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/>
                                    <circle cx="12" cy="12" r="3"/>
                                </svg>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-password-wrapper">
                            ...
                            <button type="button" class="password-toggle" aria-label="Toggle password visibility" data-target="signup-confirm-password">
                                <svg class="icon-eye" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                    <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/>
                                    <circle cx="12" cy="12" r="3"/>
                                </svg>
